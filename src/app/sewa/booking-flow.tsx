...
import { createBookingAction, getAvailabilityAction } from "./actions";
...
export function BookingFlow({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      {/* Durasi + ringkasan + form (muncul setelah jam dipilih) */}
      {startHour !== null && (
        <section className="space-y-5 rounded-2xl border bg-card p-5">
          ...
          >
            {submitting ? "Memproses..." : `Booking Sekarang · ${rupiah(total)}`}
          </button>
